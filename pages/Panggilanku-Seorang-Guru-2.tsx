...
export default function Home() {
  return (
    <>
      <Seo title="Panggilanku Seorang Guru 2: Strategi Pengajaran Brilian untuk Transformasi Pembelajaran" description="Strategi Pengajaran Brilian untuk Transformasi Pembelajaran hadir untuk menginspirasi guru agar berani keluar dari pola lama, mencoba hal baru, dan menemukan ke" />
      <Navbar />
