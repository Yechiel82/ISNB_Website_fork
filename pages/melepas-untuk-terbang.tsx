...
export default function Home() {
  return (
    <>
      <Seo title="Setiap Kita Punya Cerita" description="Empty Nest bukanlah akhir dari sebuah perjalanan, melainkan awal dari penemuan diri yang baru. Dalam keheningan, ada kesempatan untuk bertumbuh, mencintai, dan " />
      <Navbar />
