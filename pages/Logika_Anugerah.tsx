...
export default function Home() {
  return (
    <>
      <Seo title="Logika Anugerah" description="&quot;Logika Anugerah&quot; adalah sebuah eksplorasi mendalam yang secara kritis membongkar 'logika marketplace', sebuah sistem transaksional berbasis kinerja, utang, dan" />
      <Navbar />
